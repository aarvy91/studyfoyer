...
if ($_SESSION['uid']) {
	if (isset($_POST['reply_submit'])) {
		...
		$to = "noreply@studyfoyer.org";
		$from = "info@studyfoyer.org";
		// $bcc is the list of emails that will be sent out as blind carbon copies
		$bcc = $email;
		$subject = "There has been an update in the forum topic you were interested.";
		
		// This message can only contain text. NO HTML tags! The HTML tags will just be printed into the email.
		$message = "A reply has been made by a community member in the the topic you posted.
		 check it out on www.studyfoyer.org/forum.php";

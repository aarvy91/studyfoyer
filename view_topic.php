...
if (mysql_num_rows($res) == 1) {
	...
	if (@$_SESSION['uid']) { echo "<tr><td colspan='2'><input type='submit' value='Add Reply' onClick=\"window.location = 'post_reply.php?cid=".$cid."&tid=".$tid."'\" /><hr />"; } else { echo "<tr><td colspan='2'><p>Please log in to add your reply.</p><a class='submit' href='join.php'>Sign Up</a></li>
		<a class='submit' href='login.php'>Login</a></li><hr /></td></tr>"; }
